...
This project implements a complete streaming analytics system using
Apache Kafka, MongoDB, and Streamlit.\
It features two data pipelines: one for real-time monitoring and one for
...
Kafka Producer → MongoDB (Storage) → Streamlit Dashboard (Historical
View)
